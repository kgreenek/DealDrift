...
$hidden_hash_var='dealdrift_*123_secret_password';
...
function user_send_confirm_email($email,$hash) {
	...
	*/
	...
	$message = "Thank You For Registering at DealDrift.com".
		"\nSimply follow this link to confirm your registration: ".
		"\n\nhttp://www.dealdrift.com/confirm.php?hash=$hash&email=". urlencode($email).
		"\n\nOnce you confirm, you can start drifting.";
	mail ($email,'DealDrift Registration Confirmation',$message,'From: noreply@dealdrift.com');
}
